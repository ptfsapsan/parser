...
class InTimesParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "https://intimes.ru";
    ...
    private static function inflatePost(Crawler $postData): NewsPost
    {
        ...
        $original = self::ROOT_SRC . $postData->filter("link")->text();
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        $body = $crawler->filter("div#center_full div#top_center > div");
