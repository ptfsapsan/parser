...
class Novorosinform extends Aleks007smolBaseParser implements ParserInterface
{
     ...
     */
    const MAIN_PAGE_URI = 'https://novorosinform.org';

    /**
     * CSS класс, где хранится содержимое новости
     */
    const BODY_CONTAINER_CSS_SELECTOR = '.td-post-content';
     ...
     * в формате RegExp
     */
    const EXCLUDE_CSS_CLASSES_PATTERN = 'td-post-featured-image';
     ...
     */
    const FEED_URL = 'https://novorosinform.org/feed';
    ...
    public static function run(): array
    {
        ...
        $crawler->filter('channel item')->slice(0, self::MAX_NEWS_COUNT)->each(function ($node) use (&$curl, &$posts) {
            ...
            if (!empty($newsContent)) {
                 ...
                 */
                $annotation = $newsContent->filter('.td-post-featured-image figcaption');
