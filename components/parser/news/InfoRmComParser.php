...
/**
 * Парсер новостей с сайта https://info-rm.com/
 */
class InfoRmComParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    const SITE_URL = 'https://info-rm.com';
    ...
    public function parse(): array
    {
        ...
        foreach ($newsList as $newsUrl) {
            ...
            $content = $itemCrawler->filterXPath('//div[@class="news-detail-body"]');
            $title = $content->filterXPath('//h1[@class="news-detail-title"]')->text();
            $date = $this->getDate($content->filterXPath('//div[@class="news-detail-date"]')->text());
            $image = null;
            ...
            $description = '';
            $descriptionSrc = $itemCrawler->filterXPath('//div[@class="news-detail-content"]');
            ...
            $newContentCrawler = $content->filterXPath('//div[@class="news-detail-content"]')->children();
    ...
    protected function getListNews(string $page): array
    {
        ...
        $list = $crawler->filterXPath('//div[@class="news-item"]')->filterXPath('//a[@class="title"]');
