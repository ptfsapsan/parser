...
class GornoAltaiskParser extends AbstractBaseParser
{
    ...
    {
        return 'https://www.gorno-altaisk.info';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[contains(@class,"td-post-content")]');
