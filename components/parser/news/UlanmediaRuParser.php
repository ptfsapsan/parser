...
class UlanmediaRuParser extends AbstractBaseParser
{
    ...
    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve('/export/new/news_main48.rss', $this->getSiteUrl());
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.page-fullnews');
        ...
        $this->removeDomNodes($contentCrawler, '//p[contains(text(),"18+. Информационное агентство UlanMedia")]');
