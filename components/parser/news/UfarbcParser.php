...
class UfarbcParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://ufa.rbc.ru/';
    public const NEWSLIST_URL = 'https://ufa.rbc.ru/ufa/';
