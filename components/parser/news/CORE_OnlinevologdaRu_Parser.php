...
class CORE_OnlinevologdaRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'site'    => [
                ...
                // y - год, две цифры
                // H - час
                // i - минуты  22 Октября 2020, 17:20
