...
class ProvinceParser extends AbstractBaseParser
{
    ...
    public static function run(): array
    {
        ...
        return $parser->parse(5, 20);
    }

    protected function getSiteUrl(): string
    {
        return 'https://www.province.ru';
    }

    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        $previewList = [];
        $url = "/component/obrss/provintsiya-ru.feed";
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $image = null;
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"itemImageBlock")]//img');
        ...
        $descriptionCrawler = $newsPostCrawler->filterXPath('//div[@id="itemIntroText2"]');
