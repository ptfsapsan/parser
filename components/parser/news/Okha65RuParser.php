...
/**
 * Парсер новостей с сайта https://okha65.ru/
 */
class Okha65RuParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    const SITE_URL = 'https://okha65.ru';
    ...
    public function parse(): array
    {
        ...
        $urlNews = self::SITE_URL . '/rss/feed/news';
        ...
        foreach ($newsList as $newsItem) {
            ...
            $content = $newsCrawler->filterXPath('//div[@class="content_item news_item"]');

            $description = '';
            $descriptionSrc = $content->filterXPath('//div[@class="field ft_html f_content auto_field"]/div[@class="value"]');
            ...
            $newContentCrawler = $content->filterXPath('//div[@class="field ft_html f_content auto_field"]/div[@class="value"]');
