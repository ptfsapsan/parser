...
class InPodolskParser implements ParserInterface
{
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"b-page__content")]');
        ...
        $description = $newsPageCrawler->filterXPath('//div[@class="b-page__content"]//div[1]//p[1] | //div[@class="b-page__content"]//p[1]')->text();
        ...
        $this->removeDomNodes($contentCrawler, '//div[@class="b-page__content"]//div[1]//p[1] | //div[@class="b-page__content"]//p[1]');
        $this->removeDomNodes($contentCrawler, '//p[@class="print"]');
