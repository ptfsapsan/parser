...
/**
 * News parser from site http://ufc-fight.ru
 * @author jcshow
 */
class UfcFightParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://ufc-fight.ru';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        ');
        self::removeNodes($crawler, '//span[contains(@class,"tags-links")]');

        //Get image if exists
        $picture = null;
        $imageBlock = $crawler->filterXPath('
            //article[contains(@class,"post")]
            //div[contains(@class, "featured-thumb")]
            //img[1]
        ')->getNode(0);
        ...
        $detailPage = $crawler->filterXPath('//article[contains(@class,"post")]//div[contains(@class, "entry-content")]')->getNode(0);
