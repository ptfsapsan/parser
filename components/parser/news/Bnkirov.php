 ...
 *
 */
class Bnkirov extends Aleks007smolBaseParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
     ...
     */
    const MAIN_PAGE_URI = 'https://bnkirov.ru';

    /**
     * CSS класс, где хранится содержимое новости
     */
    const BODY_CONTAINER_CSS_SELECTOR = '.new--body__text-description';
     ...
     */
    const FEED_URL = 'https://bnkirov.ru/feed/';
