...
class NewsFrolParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://newsfrol.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@itemprop,"articleBody")]');
        ...
        $this->removeDomNodes($contentCrawler, '//div[@itemprop="articleBody"]//p[1]');
