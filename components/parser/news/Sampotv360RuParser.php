...
class Sampotv360RuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $tagsCrawler = $contentCrawler->filterXPath('//p[last()]/a[contains(text(),"#")][1]');
        if ($this->crawlerHasNodes($tagsCrawler)) {
