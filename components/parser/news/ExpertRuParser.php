...
class ExpertRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://expert.ru';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve('/doc-list/rss', $this->getSiteUri());
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@id="loaded_article-0"]');
        
        $this->removeDomNodes($newsPostCrawler, '//*[contains(text(), "Фото:")]
        | //*[contains(concat(" ",normalize-space(@class)," ")," __rusindustry_text ")]/following-sibling::*
        | //*[contains(concat(" ",normalize-space(@class)," ")," __rusindustry_header-section ")]
        | //*[contains(concat(" ",normalize-space(@class)," ")," __rusindustry_aside ")]
        | //*[contains(@id, "ads")]');
