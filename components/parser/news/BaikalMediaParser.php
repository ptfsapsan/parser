...
/**
 * News parser from site https://www.baikal-media.ru/
 * @author jcshow
 */
class BaikalMediaParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://www.baikal-media.ru';
    ...
    public static function getNewsData(): array
    {
        ...
        /** Get RSS news list */
        $curl = Helper::getCurl();
        $newsList = $curl->get(static::SITE_URL . "/rss/news.php");
        if (! $newsList) {
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        $description = $descCrawler->filterXPath('//text()')->getNode(0)->textContent;
        ...
        self::removeNodes($crawler, '//comment() | //hr | //script | //style | //form 
        | //header | //head | //noscript');

        $detailPage = $crawler->filterXpath('
            //div[contains(@class,"col_2")]
            //div[contains(@class,"news_main")][2]
