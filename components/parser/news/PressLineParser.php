...
class PressLineParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://www.press-line.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"page__content")]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[contains(@class,"entry__content")]');
        ...
        $this->removeDomNodes($contentCrawler, '//p/em');
        $this->removeDomNodes($contentCrawler, '//div[@class="entry__likes"]');
