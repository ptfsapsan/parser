 ...
 * @fullrss
 */
class OreltimesRuParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    protected static function parseNode(Crawler $node, ?string $filter = null) : void
    {
        ...
        if($node->nodeName() == 'p' && strpos($node->html(), '<a rel="nofollow" href="https://oreltimes.ru">')) {
            return;
        }
