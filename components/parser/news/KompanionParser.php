...
class KompanionParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "https://www.newsko.ru";
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        foreach ($body as $bodyNode) {
            ...
            if ($node->matches("p.paragraph-style-542043") && !empty(trim($node->text(), "\xC2\xA0"))) {
