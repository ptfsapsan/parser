...
class ProGorod58RuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(concat(" ",normalize-space(@class)," ")," article ")]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//*[@id="data-io-article-url"]');
