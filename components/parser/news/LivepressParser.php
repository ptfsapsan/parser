...
class LivepressParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"post-content")]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[contains(@class,"post-text")]');
        $this->removeDomNodes($contentCrawler,'//div[contains(@class,"social-share")]');
