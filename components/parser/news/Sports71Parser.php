...
class Sports71Parser extends AbstractBaseParser
{
    ...
    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $previewNewsCrawler->each(function (Crawler $newsPreview) use (&$previewList) {
            ...
            $publishedAt = DateTimeImmutable::createFromFormat('Y-m-d H:i:s', $publishedAtString);
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//meta[@property="og:image"]')->last();
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[@class="post-content"]');
