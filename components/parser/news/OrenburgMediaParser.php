...
class OrenburgMediaParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $image = null;
        $mainImageCrawler = $newsPostCrawler->filterXPath('//div[contains(@class,"featured-image")]//img');
