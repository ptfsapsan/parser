...
class TochkanewsRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $descriptionCrawler = $contentCrawler->filterXPath('//header/*[contains(@class,"post-subtitle")]');
        if ($this->crawlerHasNodes($descriptionCrawler)) {
            $descriptionText = Text::trim($this->normalizeSpaces($descriptionCrawler->text()));
            if ($descriptionText) {
                $description = $descriptionText;
                $this->removeDomNodes($contentCrawler, '//header/*[contains(@class,"post-subtitle")]');
            }
        }
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"tagcloud")]');
