...
class BpRbsmiRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.container .data-news-detal');
        $this->removeDomNodes($contentCrawler, '//span[contains(@class,"time")]/preceding-sibling::*');
        $this->removeDomNodes($contentCrawler, '//span[contains(@class,"time")]');
        $this->removeDomNodes($contentCrawler, '//p[contains(text(),"#")][last()]');
