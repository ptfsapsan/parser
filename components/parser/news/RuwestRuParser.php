 ...
 * @fullrss
 */
class RuwestRuParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://ruwest.ru/';
    public const NEWSLIST_URL = 'https://ruwest.ru/news/rss/';
    ...
    public const ARTICLE_BREAKPOINTS = [
        'text' => [
            '© ИА Русский Запад/аш' => false,
            '© ИА Русский Запад/пс' => false,
            '(с) ИА Русский Запад/ен' => false,
            'Агрегатор новостей 24СМИ' => false,
        ],
        'href' => [
            'https://24smi.info/?utm_source=informer_13499' => false,
        ]
    ];
    ...
    public static function run(): array
    {
        ...
        $listCrawler->filterXPath(self::NEWSLIST_POST)->slice(0, self::NEWS_LIMIT)->each(function (Crawler $node) use (&$posts) {
            ...
            $content = html_entity_decode(self::getNodeData('text', $node, self::NEWSLIST_CONTENT));
