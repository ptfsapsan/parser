...
class vKurseVoronezhParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://v-kurse-voronezh.ru';
    ...
    private function parseNewsPage(NewsPostDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//*[contains(@id,"main")]//div[contains(@class,"post-img")]')->first();
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//*[contains(@id,"main")]//div[contains(@class,"entry-content")]');
