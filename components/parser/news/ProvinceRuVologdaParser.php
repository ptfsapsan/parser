 ...
 * @fullrss
 */
class ProvinceRuVologdaParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    //public const SITE_URL = 'https://www.province.ru/vologda/';
    public const NEWSLIST_URL = 'https://www.province.ru/vologda/component/obrss/vologda-provintsiya-ru.feed';
    ...
    public const ARTICLE_IMAGE = '.itemImage img';
    public const ARTICLE_DESC = '.itemImageBlock .itemIntroText';
        ...
        $listCrawler->filterXPath(self::NEWSLIST_POST)->slice(0, self::NEWS_LIMIT)->each(function (Crawler $node) use (&$posts) {
            ...
            if (!empty($articleContent)) {
                ...
                if($image) {
                    ...
                    $image = str_ireplace('_S.jpg', '_M.jpg', self::$post->image);
