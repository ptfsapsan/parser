 ...
 *
 */
class Sochistream extends Aleks007smolBaseParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
     ...
     */
    const MAIN_PAGE_URI = 'https://sochistream.ru';
     ...
     */
    const FEED_URL = 'https://sochistream.ru/feed/';
