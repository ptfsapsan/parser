...
class PestrecyRTRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://pestrecy-rt.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        try {
            $image = $newsPageCrawler->filterXPath('//*[@class="page-main__img"]')->attr('src');
        } catch (\Throwable $th) {
            
        }
        
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="page-main__text"] | //div[@class="gallery"]');
