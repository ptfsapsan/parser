...
class ArtMoskoviaRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://artmoskovia.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="td-post-content"]');
        ...
        | //div[@class="td-post-content"]//*[descendant::a[contains(@href, "artmoskovia")]][last()]');
