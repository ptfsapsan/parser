...
class MossovetInfoParser implements ParserInterface
{
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"news-detail")]');

        $mainImageCrawler = $newsPageCrawler->filterXPath('//img[@class="preview_picture"]')->first();
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//p[@style="text-align: justify;"][1]');
        ...
        $this->removeDomNodes($contentCrawler, '//div[@class="tags"]');
