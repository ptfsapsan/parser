...
class October31RuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://october31.ru';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve("edw/api/data-marts/32/entities.json?&limit={$maxNewsCount}", $this->getSiteUri());
        ...
        foreach ($previewNewsContent['results']['objects'] as $object) {
            ...
            $uri = UriResolver::resolve($object['extra']['url'], $this->getSiteUri());
