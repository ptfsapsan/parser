...
class ApnParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://www.apn.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="full-str"]');

        $description = explode('.', $newsPostCrawler->filterXPath('//div[1]')->text());
        $this->removeDomNodes($newsPostCrawler, '//div[2]');
        ...
        $this->removeDomNodes($newsPostCrawler, '//*[name()="i" and self::*/a[contains(@href, "t=author")]]');
        $this->removeDomNodes($newsPostCrawler, '//table');
        $this->removeDomNodes($newsPostCrawler, '//noscript | //script | //video');
