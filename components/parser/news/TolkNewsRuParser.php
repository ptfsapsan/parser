...
class TolkNewsRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://tolknews.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //div[contains(concat(" ",normalize-space(@class)," ")," b-detail__social-typography ")]
        | //div[contains(concat(" ",normalize-space(@class)," ")," inject-long ")]');
