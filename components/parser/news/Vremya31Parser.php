...
class Vremya31Parser implements ParserInterface
{
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        foreach ($previewNewsContent['results']['objects'] as $object){
            ...
            $publishedAt = DateTimeImmutable::createFromFormat('Y-m-d\TH:i:s\Z', $publishedAtString,new DateTimeZone('Europe/Moscow'));
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $uri = UriResolver::resolve($newsContent['detail_url'],$this->getSiteUri());
