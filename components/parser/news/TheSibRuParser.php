...
class TheSibRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//*[following-sibling::*[contains(concat(" ",normalize-space(@class)," ")," ya-share2 ")]][last()]/following-sibling::*
        | //*[contains(text(), "Вести Новосибирск")]
        | //*[contains(text(), "Поделиться статьёй:")]');
