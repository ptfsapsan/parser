...
class VestiKhakassiaParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'http://xn----8sbafpsdo3dff2b1j.xn--p1ai';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPost = new NewsPost(self::class, $title, self::EMPTY_DESCRIPTION_KEY, $publishedAtFormatted, $uri, $image);
