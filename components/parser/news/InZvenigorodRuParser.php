...
class InZvenigorodRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://inzvenigorod.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(concat(" ",normalize-space(@class)," ")," b-page__main ")]');
        

        $this->removeDomNodes($newsPostCrawler, '//*[contains(text(), "Фото:")]
        | //*[contains(concat(" ", normalize-space(@class), " "), " b-page__title ")]
        | //*[contains(concat(" ", normalize-space(@class), " "), " b-page__single-date ")]
        | //*[contains(concat(" ", normalize-space(@class), " "), " b-page__content ")]/following-sibling::*
