...
class Ntr24Parser extends AbstractBaseParser
{
    ...
    {
        return 'https://ntr-24.ru';
    }

    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        $previewList = [];
        $url = "/index.php?mod=rss";
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[@itemprop="articleSection"]');
