...
class LehiZdatParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://lenizdat.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="textdiv"]');

        $description = $newsPostCrawler->filterXPath('//p[1]')->text();
        $this->removeDomNodes($newsPostCrawler,'//div[@class="textdiv"]//p[1]');
        ...
        $this->removeDomNodes($contentCrawler, '//figure[contains(@class,"fulltext__photo-wrap")]');
