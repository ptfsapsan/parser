...
class UstKut24Parser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://www.ust-kut24.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//article[starts-with(@id,"post-")]');

        $mainImageCrawler = $contentCrawler->filterXPath('//header[contains(@class,"entry-header")]//p//img')->first();
