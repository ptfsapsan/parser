...
/**
 * News parser from site https://skr.su/
 * @author jcshow
 */
class SkrSuParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://skr.su';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        self::removeNodes($crawler, 'div[contains(@class,"wrap-banner-top")]');
        ...
        $imageBlock = $crawler->filterXPath('
            ...
            //div[contains(@class,"news-post")][1]
            //div[contains(@class,"news-post_photo")]
            //img[1]
        ')->getNode(0);
        ...
        $descriptionBlock = $crawler->filterXPath('
            //div[contains(@class,"content")]
            //div[contains(@class,"news-post")][2]
            //div[contains(@class,"news-post_contents")]
