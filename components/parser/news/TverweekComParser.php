...
class TverweekComParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.post .single_post .post-single-content');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"share42init")] | //div[contains(@class,"tags")]');
