...
class NewsdeloComParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://newsdelo.com';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('article.post:first-child .btArticleContentWrap > .btArticleContent');
        $this->removeDomNodes($contentCrawler, '//*[contains(@class,"btArticleDate")]');
