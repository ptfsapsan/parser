...
/**
 * News parser from site http://gazeta-nashe-moskvoreche-saburovo.ru/
 * @author jcshow
 */
class MoskvorecheSaburovoParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://gazeta-nashe-moskvoreche-saburovo.ru/';
    ...
    public static function getPostDetail(SimpleXMLElement $item)
    {
        ...
        self::removeNodes($crawler, '//div[contains(@class, "menu-section")]');
        ...
        /** Get description */
        $descriptionBlock = $crawler->filterXpath('//div[contains(@class,"entry-content")]//*[1][string()]')->getNode(0);
