 ...
 * @rss_html
 */
class NewsruComParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://www.newsru.com/';
    public const NEWSLIST_URL = 'https://rss.newsru.com/all_news';
    ...
    public const ARTICLE_IMAGE = '.article-list-img .big-img';
    public const ARTICLE_TEXT = '.article .article-text';
    ...
    public static function run(): array
    {
        ...
        $listCrawler->filterXPath(self::NEWSLIST_POST)->slice(0, self::NEWS_LIMIT)->each(function (Crawler $node) use (&$posts) {
            ...
            if (!empty($articleContent)) {
                ...
                self::$post->image = self::getNodeImage('style', $articleCrawler, self::ARTICLE_IMAGE);
