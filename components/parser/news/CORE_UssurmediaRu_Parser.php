    ...
    public function __construct()
    {
        $this->config = [
            ...
            'rss'     => [
                ...
                // (обязательный)
                'url'                 => '/export/new/news_main117.rss',
            ...
            'element' => [
                ...
                // (опционально)
                'ignore-selectors'    => '.news_links_related, .inside_banner, #soc_invites_block, #adv',
