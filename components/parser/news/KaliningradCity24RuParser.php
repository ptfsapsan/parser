...
class KaliningradCity24RuParser extends AbstractBaseParser
{
    ...
    {
        return 'http://kaliningrad-city24.ru';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(concat(" ",normalize-space(@class)," ")," c-news-item ")][descendant::div[@class="c-social-buttons"]]');
        ...
        | //div[contains(concat(" ",normalize-space(@class)," ")," c-social-buttons ")]/following-sibling::*
        | //div[contains(concat(" ",normalize-space(@class)," ")," c-social-buttons ")]');
