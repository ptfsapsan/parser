...
class NovochvedomostiRuParser extends AbstractBaseParser
{
    ...
    {
        return 'https://novochvedomosti.ru';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $mainImageCrawler = $contentCrawler->filterXPath('//div[contains(@class,"entry-header")]//img[1]');
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"view-links")]');
