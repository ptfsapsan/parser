...
class NewsnordRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.post .the_content');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"social-likes")]');
