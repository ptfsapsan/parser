...
class ZarenRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://zaren.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//article[contains(@id,"the-post")]//div[contains(@class,"entry")]');

        $mainImageCrawler = $contentCrawler->filterXPath('//*[contains(@class,"wp-block-image")]//img[1]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@id,"ArticleThumbsContainer")]');

        if ($this->crawlerHasNodes($mainImageCrawler)) {
            $image = $mainImageCrawler->attr('src');
            $this->removeDomNodes($contentCrawler, '//*[contains(@class,"wp-block-image")]//img[1]');
        }
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"wp-polls")]');
