...
class DivnogorskOyeRfParser extends AbstractBaseParser
{
    ...
    {
        return 'http://xn----ctbdcioqwjbcvn.xn--p1ai/';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('article.post .td-post-content');
        $this->removeDomNodes($contentCrawler, '//*[contains(@class,"nostyle")]');
        $this->removeDomNodes($contentCrawler, '//*[contains(@class,"yarpp-related")]');

        $image = null;

        $mainImageCrawler = $contentCrawler->filterXPath('//div[contains(@class,"td-post-featured-image")]//img[contains(@class,"td-modal-image")]/parent::a');
