...
class GazetaBalakovaParser extends AbstractBaseParser
{
    ...
    {
        return 'https://gazetabalakovo.ru/';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//article[@id="the-post"]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[contains(@class,"entry-content entry clearfix")]');

        $this->removeDomNodes($contentCrawler,'//div[@id="jp-relatedposts"]');
        $this->removeDomNodes($contentCrawler,'//div[@class="post-bottom-meta"]');
