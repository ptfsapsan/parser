...
class YsiaRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.elementor-widget-theme-post-content');

        if (!$previewNewsDTO->getImage()) {
            $image = null;
            $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"elementor-widget-theme-post-featured-image")]//img[1]');
