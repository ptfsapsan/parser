...
class IujnoeMedvedkovoParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "https://medvedkovo-juzhnoe.mos.ru";

    const FEED_SRC = "/rssexport/";
    const LIMIT = 100;
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        $body = $crawler->filter("article.b-text-content");
