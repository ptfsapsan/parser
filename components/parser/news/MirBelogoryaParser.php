...
class MirBelogoryaParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://mirbelogorya.ru/';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve("/index.php?option=com_ninjarsssyndicator&feed_id=1&format=raw", $this->getSiteUri());
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//img[contains(@src, "https://mirbelogorya.ru/mb.png")]');
