...
class Gazeta45ComParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('#content .post .entry');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"st-post-tags")]');
