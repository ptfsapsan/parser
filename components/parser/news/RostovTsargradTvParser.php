 ...
 * @fullhtml
 */
class RostovTsargradTvParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://rostov.tsargrad.tv/';
    public const NEWSLIST_URL = 'https://rostov.tsargrad.tv/news';
