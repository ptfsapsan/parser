...
class DondayNovocherkasskParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://donday-novocherkassk.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"maincont")]/img');
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"yandex-favorit")]');
        $this->removeDomNodes($contentCrawler, '//p[contains(@class,"basetags")]');
