...
class VzglyadInfoParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[contains(concat(" ",normalize-space(@class)," ")," td-post-content ")]');

        $this->removeDomNodes($contentCrawler, '//div[contains(concat(" ",normalize-space(@class)," ")," td-a-rec ")]
        | //*[@id="__utl-buttons-1"]
        | //*[@id="__utl-buttons-2"]
        | //*[@class="td-post-featured-image"]');
