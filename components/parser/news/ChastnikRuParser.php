...
class ChastnikRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//*[contains(concat(" ",normalize-space(@class)," ")," news-detail__text ")]');
