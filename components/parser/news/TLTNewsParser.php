...
class TLTNewsParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "http://www.tltnews.ru";
    ...
    public static function run(): array
    {
        ...
        $items = $crawler->filter("div.news-list > table tr div.news-item");
    ...
    private static function inflatePost(Crawler $postData): NewsPost
    {
        ...
        $original = self::ROOT_SRC . $postData->filter("a")->attr("href");


        $dateString = $postData->filter("span.news-date-time-tlt")->text();

        $createDate = DateTime::createFromFormat("d.m.y H:i:s P", $dateString . ":00 +04:00");
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        $body = $crawler->filter("div.news-detail > table > tr:nth-child(2) > td");
