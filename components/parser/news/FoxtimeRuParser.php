 ...
 * @rss_html
 */
class FoxtimeRuParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://foxtime.ru/';
    public const NEWSLIST_URL = 'https://foxtime.ru/feed/';
    ...
    public const ARTICLE_IMAGE = '.article-box img:first-of-type';
    public const ARTICLE_DESC = '.article-box p:first-of-type';
    public const ARTICLE_TEXT = '.article-box';
    ...
    public static function run(): array
    {
        ...
        $listCrawler->filterXPath(self::NEWSLIST_POST)->slice(0, self::NEWS_LIMIT)->each(function (Crawler $node) use (&$posts) {
            ...
            if (!empty($articleContent)) {
                ...
                self::$post->description = html_entity_decode(self::getNodeData('text', $articleCrawler, self::ARTICLE_DESC));
