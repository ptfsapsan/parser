 ...
 *
 */
class KurskIzvestia extends Aleks007smolBaseParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
     ...
     */
    const MAIN_PAGE_URI = 'https://kursk-izvestia.ru';
     ...
     */
    const FEED_URL = 'https://kursk-izvestia.ru/news/rss/';
