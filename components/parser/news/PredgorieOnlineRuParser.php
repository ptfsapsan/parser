...
class PredgorieOnlineRuParser extends AbstractBaseParser
{
    ...
    {
        return 'http://predgorie-online.ru';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.main .body');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"title")]');
        ...
        if (!$previewNewsDTO->getImage()) {
            ...
            if ($this->crawlerHasNodes($mainImageCrawler)) {
                ...
                $this->removeDomNodes($contentCrawler, '//img[1]/parent::a');
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@id,"vk_like")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"info")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@id,"respond")]');
