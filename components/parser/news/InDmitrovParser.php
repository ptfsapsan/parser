...
class InDmitrovParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://in-dmitrov.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="b-page__content"] | //div[@class="photo_gallery_container"]');
        ...
        $description = explode('.',$newsPostCrawler->filterXPath('//p[1]')->text());
