...
class Site15NewsParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="text"][1]');
        ...
        $this->removeDomNodes($contentCrawler,'//a[@title="Новости Осетии и Владикавказа"]');
