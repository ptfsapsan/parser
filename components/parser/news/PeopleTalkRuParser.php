...
class PeopleTalkRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@itemprop="articleBody"]');
        ...
        $this->removeDomNodes($contentCrawler, '//*[@class="site__tags"]');
