...
class ToptverParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@itemtype="https://schema.org/Article"]');
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"ya-share2")]/following-sibling::*');
