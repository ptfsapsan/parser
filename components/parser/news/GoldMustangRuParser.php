...
class GoldMustangRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://www.goldmustang.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@id="index_content"]');

        $this->removeDomNodes($newsPostCrawler, '//div[@class="button_back"]
        | //*[@class="anons"]
        | //*[@id="fb-root"]/ancestor::*[1]
        | //*[contains(text(), "Фото: ")]
        | //h1');
