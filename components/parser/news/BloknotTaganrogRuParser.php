 ...
 * @rss_html
 */
class BloknotTaganrogRuParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://bloknot-taganrog.ru/';
    public const NEWSLIST_URL = 'https://bloknot-taganrog.ru/rss_news.php';
    ...
    public const ARTICLE_BREAKPOINTS = [
        ...
        'src' => [
            '//bloknot-taganrog.ru/upload/medialibrary/a29/plashka-prizyv.jpeg' => false,
