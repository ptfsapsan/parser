...
/**
 * Парсер новостей из RSS ленты https://v-tatarstane.ru/
 *
 */
class Vtatarstane extends TyRunBaseParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const MAIN_PAGE_URI = 'https://v-tatarstane.ru';

    /**
     * CSS класс, где хранится содержимое новости
     */
    const BODY_CONTAINER_CSS_SELECTOR = '.site-main .entry-content';
     ...
     */
    const CONTENT_CSS_SELECTOR = '.twp-article-wrapper';
     ...
     */
    const CUT_CSS_REGEXP = '/social-likes/';

    /**
     * Ссылка на RSS фид (XML)
     */
    const FEED_URL = 'https://v-tatarstane.ru/feed/';
