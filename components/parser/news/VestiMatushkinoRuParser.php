...
class VestiMatushkinoRuParser extends AbstractBaseParser
{
    ...
    {
        return 'https://vesti-matushkino.ru/';
    }
    ...
    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve('/rss_page.php', $this->getSiteUrl());
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"detail-picture-div")]');
        $this->removeDomNodes($contentCrawler, '//*[contains(@class,"news-date-time")]');
        $this->removeDomNodes($contentCrawler, '//a[contains(text(),"Версия для печати")]');
        ...
        if ($this->crawlerHasNodes($descriptionCrawler)) {
            ...
            if ($descriptionText) {
                ...
                $this->removeDomNodes($descriptionCrawler, '//b[1]');
            }
        }
