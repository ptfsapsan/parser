...
class Top4ManRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@id="idpl6"]//div[1]');
        ...
        $this->removeDomNodes($contentCrawler, '//em');
