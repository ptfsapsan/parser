...
/**
 * News parser from site https://www.76online.ru/
 * @author jcshow
 */
class YaroslavlOnlineParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://www.76online.ru';
    ...
    public static function getPostDetail(DOMElement $item)
    {
        ...
        $imageBlock = $crawler->filterXPath('
            //div[contains(@class, "news_item")]
            //div[contains(@class, "news-additional-info-block")]
            //a[1]
        ')->getNode(0);
        ...
        self::removeNodes($crawler, '//div[contains(@class, "news_item")]//div[contains(@class, "news-text")]//p[1]');

        $detailPage = $crawler->filterXpath('//div[contains(@class, "news_item")]//div[contains(@class, "news-text")]')->getNode(0);
