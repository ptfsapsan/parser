...
class OspParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://www.osp.ru/';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve("/rss/allarticles.rss", $this->getSiteUri());
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="pub-content"]');
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"img-wrapper")]/img');
        ...
        $this->removeDomNodes($contentCrawler, '//div[@class="read-more-pubs"]');
        $this->removeDomNodes($contentCrawler, '//div[@class="dd-annotation"]');
        $this->removeDomNodes($contentCrawler, '//div[@class="dd-after-content"]');
        $this->removeDomNodes($contentCrawler, '//div[@class="pub-tags"]');
