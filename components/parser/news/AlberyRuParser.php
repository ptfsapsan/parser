...
class AlberyRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('#mainbox .stattext');
        $this->removeDomNodes($contentCrawler, '//h1[1]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"soderzanie")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"forlink")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"linomer")]');
