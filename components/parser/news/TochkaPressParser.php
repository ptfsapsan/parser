...
class TochkaPressParser extends AbstractBaseParser
{
    ...
    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve('/category/news/feed/', $this->getSiteUrl());
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('#main article.post .entry-content');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"mistape_caption")]');
        $this->removeDomNodes($contentCrawler, '//*[contains(text(),"реклама в TZ")]/ancestor::p');
        $this->removeDomNodes($contentCrawler, '//p[@class="has-small-font-size"]');
        ...
        $descriptionCrawler = $contentCrawler->filterXPath('//p[contains(@class,"has-medium-font-size")][1]/strong');
