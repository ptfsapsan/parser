...
class GosNovostiComParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://gosnovosti.com';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve('/yandex/news', $this->getSiteUri());
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //*[contains(text(),"Читайте нас в Яндекс")]/ancestor::*[1]/following-sibling::*
        | //*[contains(text(),"Читайте нас в Яндекс")]
        | //text()[contains(., "Не забудьте")]
        | //text()[contains(., "Вы можете пройти")]');
