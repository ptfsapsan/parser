...
class Info34374Parser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'http://34374.info/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"entry")]');
        ...
        $this->removeDomNodes($contentCrawler, '//div[@style="clear:both;"][1]/following-sibling::*');
        $this->removeDomNodes($newsPageCrawler, '//span[@class="reply left"]');
