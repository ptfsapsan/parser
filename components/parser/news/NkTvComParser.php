...
class NkTvComParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://nk-tv.com';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"bdaia-post-content")]//img[1]');
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"bdaia-post-content")]');
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"bdaia-post-content")]//img[1]');
