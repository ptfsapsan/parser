...
class KletskdonRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.post .entry-inner');
        $this->removeDomNodes($contentCrawler, '//span//strong[contains(text(),"Понравилась заметка?")]/parent::*');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"sharedaddy")]/following-sibling::*');
        ...
        if (!$previewNewsDTO->getImage()) {
            ...
            if ($this->crawlerHasNodes($mainImageCrawler)) {
                ...
                $this->removeDomNodes($contentCrawler, '//img[1]/parent::a/parent::p');
