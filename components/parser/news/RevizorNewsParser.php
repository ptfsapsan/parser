...
class RevizorNewsParser implements ParserInterface
{
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//meta[contains(@property,"og:image")]')->first();
        ...
        $this->removeDomNodes($newsPageCrawler, '//p[contains(@class, "text-description")]');
        $this->removeDomNodes($newsPageCrawler, '//div[starts-with(@class, "block-text-share")]');
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//div[contains(@id,"content")]/div[contains(@class,"block-text")]');
