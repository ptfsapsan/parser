...
class UgTsargradParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://ug.tsargrad.tv';
    ...
    private function searchHeadingNewsItem(DOMNode $node): ?NewsPostItem
    {
        ...
        $newsPostItem = new NewsPostItem(NewsPostItem::TYPE_HEADER, preg_replace('/\s+/iu', ' ', $node->textContent),
