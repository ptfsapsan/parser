...
class OgParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://og.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//div[contains(@id,"block-system-main")]//div[contains(@class,"article-section")]');

        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@id,"block-system-main")]//div[contains(@class,"article-img")]/img')->first();
