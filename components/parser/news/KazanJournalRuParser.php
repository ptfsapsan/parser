...
class KazanJournalRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'http://www.kazan-journal.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//img[contains(@class,"page-main__img")]');
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"page-main__text")]');
