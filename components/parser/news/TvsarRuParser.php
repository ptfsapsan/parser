...
class TvsarRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"video-desc")]//div[contains(@class,"ya-share2")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"video-desc")]//div[contains(@class,"tags")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"video-desc")]//p[contains(@class,"info")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"video-desc")]//div[contains(@id,"codeContrainer")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"video-desc")]//h2[1]');

        $contentCrawler = $contentCrawler->filterXPath('//div[contains(@class,"video-wrapper")] | //div[contains(@class,"video-desc")]');
