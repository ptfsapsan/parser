...
class SochiParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    private const LINK = 'https://sochi.com/news/';
    private const DOMAIN = 'https://sochi.com';
    ...
    public static function run(): array
    {
        ...
        $items = $parser->find('.news-list > div');
        if (count($items)) {
            $n = 0;
            foreach ($items as $item) {
                ...
                $createDate = trim($item->find('.date')->text());
