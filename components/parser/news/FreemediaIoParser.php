...
class FreemediaIoParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://freemedia.io';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.content > .post');

        $mainImageCrawler = $newsPageCrawler->filter('.featured-media img');
        ...
        $contentCrawler = $contentCrawler->filter('.post-content');
        ...
        $this->removeDomNodes($contentCrawler, '//a[contains(@class,"telegram-subscribe")]');
