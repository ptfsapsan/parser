...
class KrasnogorskOnlineParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "http://www.krasnogorskonline.ru";
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        $picHolder = $crawler->filter("div.ep div.ep-img");
        if ($picHolder->count() !== 0) {
            $imageContainer = $picHolder->attr("style");
        ...
        $body = $crawler->filter("div.ep div.ep-mes");
