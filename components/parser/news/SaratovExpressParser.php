...
class SaratovExpressParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@class="post-wrap"]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//*[@class="content-inner"]');
