...
class NirvanaSiteParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "http://nirvanasite.org";
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        $body = $crawler->filter("div#main_content div.post-body");
        ...
        foreach ($body->children() as $bodyNode) {
            ...
            if ($node->matches("div.post-caption")) {
                continue;
            }
