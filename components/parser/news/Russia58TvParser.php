...
class Russia58TvParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //*[following-sibling::*[contains(concat(" ",normalize-space(@class)," ")," eror_button ")]][last()]/following-sibling::*');
