...
class News2WorldNetParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//*[@itemprop="articleBody"]//*[contains(@class,"description")]');
