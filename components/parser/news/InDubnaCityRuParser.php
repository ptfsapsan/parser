...
class InDubnaCityRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://indubnacity.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="b-page__image"] | //div[@class="b-page__content"]');

        $this->removeDomNodes($newsPostCrawler, '//*[contains(text(), "Фото:")]
        | //*[@class="print"]
        | //p/em[contains(text(), "Дубн")]');
