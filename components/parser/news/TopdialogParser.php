...
class TopdialogParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://topdialog.ru';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $previewNewsCrawler->each(function (Crawler $newsPreview) use (&$previewList) {
            ...
            $uri = UriResolver::resolve($uri, "{$this->getSiteUri()}/news/news-list/");
            ...
            $preview = html_entity_decode(trim(strip_tags($newsPreview->filterXPath('//description')->text())));
