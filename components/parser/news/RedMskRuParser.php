...
class RedMskRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://red.msk.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //p[descendant::em/a]
        | //p[descendant::a/em]
        | //p[descendant::em/a]/following-sibling::*
        | //p[descendant::a/em]/following-sibling::*
        | //*[following-sibling::*[@class="wp-block-quote"]][last()]/following-sibling::*');
