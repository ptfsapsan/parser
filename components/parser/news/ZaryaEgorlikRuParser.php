 ...
 * @rss_html
 */
class ZaryaEgorlikRuParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const ARTICLE_DESC = '.post-content .entry-content h5';
    public const ARTICLE_TEXT = '.post-content .entry-content';

    public const ARTICLE_BREAKPOINTS = [
        'class' => [
            'yandex-share-title' => false,
            'ya-share2' => false,
            'ya-share2_inited' => false,
            'ya-share2__container' => false,
            'ya-ya-share2__list' => false,
        ]
    ];
