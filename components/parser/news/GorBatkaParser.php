...
class GorBatkaParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="elementor-inner"] | //div[@data-widget_type="theme-post-content.default"]');
        $this->removeDomNodes($newsPageCrawler,'//div[contains(@class,"sharethis-inline-share-buttons")]');
