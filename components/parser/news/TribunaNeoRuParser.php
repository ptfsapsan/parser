...
class TribunaNeoRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.post .the_content_wrapper');

        $image = null;

        $mainImageCrawler = $contentCrawler->filterXPath('//img[contains(@class,"wp-post-image")][1]/parent::a[contains(@class,"wfml-single")]');
