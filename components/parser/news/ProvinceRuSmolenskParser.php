...
class ProvinceRuSmolenskParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    //public const SITE_URL = 'https://www.province.ru/smolensk/';
    public const NEWSLIST_URL = 'https://www.province.ru/smolensk/component/obrss/smolensk-provintsiya-ru.feed';
