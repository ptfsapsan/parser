...
class BeregVrnParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    private const LINK = 'http://www.bereg.vrn.ru/31.html';
    private const DOMAIN = 'http://www.bereg.vrn.ru';
    ...
    public static function run(): array
    {
        ...
        $items = $parser->find('#content .news1');
        if (count($items)) {
            $n = 0;
