...
/**
 * News parser from site http://gazeta-danilovsky-vestnik.ru/
 * @author jcshow
 */
class DanilovskyVestnikParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'http://gazeta-danilovsky-vestnik.ru';
