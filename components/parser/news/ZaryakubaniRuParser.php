...
class ZaryakubaniRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.container .wrapper .post__content');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"post__action--tag")]');
