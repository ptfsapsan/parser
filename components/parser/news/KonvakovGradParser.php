...
class KonvakovGradParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://konakovograd.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@id="publication_text"][1]');
        ...
        $this->removeDomNodes($newsPostCrawler, '//div[@id="date_social"]');
        $this->removeDomNodes($newsPostCrawler, '//time[@id="content_date"]');
        $this->removeDomNodes($newsPostCrawler, '//div[contains(@class, "vortex-container-vote")]');
