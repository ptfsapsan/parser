...
class AromashevoOnlineParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://aromashevo.online';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="page-single"]/div[contains(concat(" ",normalize-space(@class)," ")," post-content ")] | //div[@class="page-single"]/div[contains(concat(" ",normalize-space(@class)," ")," post-image")]');
        

        $this->removeDomNodes($newsPostCrawler, '//*[contains(text(), "Фото:")]
        | //*[@class="tagcloud"]
        | //*[@class="imgtitle"]
        | //p[descendant::*[contains(text(), "Источник:")]]');
