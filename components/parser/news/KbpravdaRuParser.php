...
class KbpravdaRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.node-article .field-type-text-with-summary .field-item');

        $image = null;
        $mainImageCrawler = $newsPageCrawler->filter('.node-article .field-type-image img');
