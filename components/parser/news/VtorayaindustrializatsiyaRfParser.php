...
class VtorayaindustrializatsiyaRfParser extends AbstractBaseParser
{
    ...
    {
        return 'https://xn--80aaafltebbc3auk2aepkhr3ewjpa.xn--p1ai/';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"kntev")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"code-block")]');
        $this->removeDomNodes($contentCrawler, '//p[contains(@class,"kartavi")]/following-sibling::*');
        $this->removeDomNodes($contentCrawler, '//p[contains(@class,"kartavi")]');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"post-views")]');

        $image = null;
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"featured-image")]/img[1]');
