...
class NewsMentParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    private const LINK = 'https://newsment.ru/';
    ...
    public static function run(): array
    {
        ...
        if (count($items)) {
            ...
            foreach ($items as $item) {
                ...
                $a = $item->find('h2.entry-title.entry--item a');
                $title = trim($a->text());
