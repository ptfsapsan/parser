...
class NashKraiRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://nash-krai.ru';
    ...
    private function getPreviewList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        ...
        $uriPreviewPage = UriResolver::resolve('/index.php/component/k2/itemlist?format=feed&type=rss', $this->getSiteUri());
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(concat(" ",normalize-space(@class)," ")," itemIntroText ")]
        | //div[contains(concat(" ",normalize-space(@class)," ")," itemFullText ")]');
        ...
        | //p[following-sibling::*[contains(text(), "Читайте также")]][last()]/following-sibling::*
        | //p[contains(text(), "По материалам")]');
