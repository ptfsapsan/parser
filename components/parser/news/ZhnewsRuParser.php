...
class ZhnewsRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://zhnews.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"elementor-widget-theme-post-featured-image")]//img[1]')->first();
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"elementor-widget-theme-post-content")]');
    ...
    {
        return $this->encodeUrl(self::SITE_URL);
    }
