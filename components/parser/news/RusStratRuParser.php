...
class RusStratRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@id="content"]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//*[@id="block-system-main"]//*[contains(concat(" ",normalize-space(@class)," ")," field-item ")][child::p]');
