 ...
 * @fullhtml
 */
class KommersantRegions2Parser extends MediasferaNewsParser implements ParserInterface
{
    ...
    //public const SITE_URL = 'https://www.kommersant.ru/regions/2';
    public const NEWSLIST_URL = 'https://www.kommersant.ru/regions/2';
