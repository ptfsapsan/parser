...
class CORE_RuspravdaInfo_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
        ...
        $this->config = [
            ...
            'element' => [
                ...
                'container'           => 'td.content_bg',
                    ...
                    // (опционально)
                    'element-image'       => 'a.gallery img[src]',
                ...
                // (опционально)
                'ignore-selectors'    => '.informer, .news_header, .breadcrumbs, a.gallery, div[style="width:750px;"], #M256574ScriptRootC683833, h1, noindex, div[style="text-align:right;font-size:10px;color:#999;"]',
