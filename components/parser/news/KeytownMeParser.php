...
class KeytownMeParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://keytown.me';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//*[contains(@id,"main")]//article//div[contains(@class,"meta-image")]/img')->first();
        ...
        $contentCrawler = $newsPageCrawler->filter('#main .entry-content');

        $this->removeDomNodes($contentCrawler, '//h4[1]');
