...
class VolgOnlineParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://www.volgonline.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//div[@class="ya-share2"]');
        $this->removeDomNodes($contentCrawler, '//div[@class="news-additional-info-block"]');
        $this->removeDomNodes($contentCrawler, '//div[@class="header"]');
        $this->removeDomNodes($contentCrawler, '//h1[@id="news-title"]');
        $this->removeDomNodes($contentCrawler, '//div[@class="news-text"]//p[1]');
        $this->removeDomNodes($contentCrawler, '//div[@class="news-text"]//p[2]');
