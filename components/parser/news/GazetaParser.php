...
class GazetaParser extends AbstractBaseParser
{
    ...
    {
        return 'https://www.gazeta.ru';
    }

    protected function getPreviewNewsDTOList(int $minNewsCount = 10, int $maxNewsCount = 100): array
    {
        $previewList = [];
        $url = "/export/rss/lenta.xml";
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[@id="article_main_video"] | //div[@itemprop="articleBody"]');
