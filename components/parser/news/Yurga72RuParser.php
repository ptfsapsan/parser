...
class Yurga72RuParser implements ParserInterface
{
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"post_content")]//*[contains(@class,"magnificPopupImage")]/img');

        if ($this->crawlerHasNodes($mainImageCrawler)) {
            $image = $mainImageCrawler->attr('src');
            $this->removeDomNodes($newsPageCrawler, '//div[contains(@class,"magnificPopupImage")]/img');
        }
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"post_main_container")]');
