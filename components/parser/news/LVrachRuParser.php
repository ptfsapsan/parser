...
class LVrachRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://www.lvrach.ru/';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(concat(" ", normalize-space(@id), " "), " main_col_ ")]');

        // $this->removeDomNodes($newsPostCrawler, '//div[@id="__utl-buttons-1"]');

        $this->removeDomNodes($newsPostCrawler, '//div[@class="preview_text"]
        | //div[contains(concat(" ", normalize-space(@class), " "), " article-tags ")]
