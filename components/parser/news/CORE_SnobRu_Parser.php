...
class CORE_SnobRu_Parser extends ParserCore implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'element' => [
                ...
                // (обязательный)
                //                'container'           => '.col-entry.col-md-11.col-lg-9.col-lg-offset-1',
                ...
                // (можно несколько через запятую, если есть разные шаблоны новости)
                // (обязательный)
                'element-text'        => '.row .col-entry:first-child article.entry__body .text',
                ...
                // (опционально)
                'ignore-selectors'    => '.lead, .meta, blockquote.instagram-media',
