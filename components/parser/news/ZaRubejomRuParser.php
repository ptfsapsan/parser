...
class ZaRubejomRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://www.zarubejom.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //div[contains(concat(" ",normalize-space(@class)," ")," td-post-content ")]/p[last()]/em');
