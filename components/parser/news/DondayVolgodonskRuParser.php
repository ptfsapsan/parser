...
class DondayVolgodonskRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'https://donday-volgodonsk.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@class="base fullstory"]')->first();
        
        $this->removeDomNodes($newsPostCrawler, '//div[@class="main_head"]
        | //*[@class="btl"]
        | //div[@class="mlink"]
        | //div[@class="maincont"]//b');
    ...
    private function searchImageNewsItem(DOMNode $node, PreviewNewsDTO $previewNewsItem): ?NewsPostItem
    {
        ...
        $imageLink = $node->getAttribute('data-src');
