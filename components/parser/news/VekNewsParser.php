 ...
 * @rss_html
 */
class VekNewsParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://vek.news/';
    public const NEWSLIST_URL = 'https://vek.news/feed/';
    ...
    public const ARTICLE_DESC = '.post-single .post-content-single :first-child';
    public const ARTICLE_TEXT = '.post-single .post-content-single';
