...
class VideoNovostiParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;

    const ROOT_SRC = "https://xn--90abgenohw1c.xn--p1acf";

    const FEED_SRC = "/rss/content/15/feed.rss";
    const LIMIT = 100;
    ...
    private static function inflatePost(Crawler $postData): NewsPost
    {
        ...
        $originalArr[2] = "xn--90abgenohw1c.xn--p1acf";

        $original = implode("/", $originalArr);
    ...
    private static function inflatePostContent(NewsPost $post, Curl $curl)
    {
        ...
        $body = $crawler->filter("div#main div.component div.con_text");
