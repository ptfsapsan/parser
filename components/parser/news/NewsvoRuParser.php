...
class NewsvoRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.news_content .news_main_text');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"article_gallery")]');
