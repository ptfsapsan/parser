...
class OreninformRuParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    public const SITE_URL = 'http://oreninform.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="matdetail"]');
        ...
        | //*[following-sibling::*[@class="author_cont"]][last()]/following-sibling::*
        | //h1
        | //div[contains(concat(" ",normalize-space(@class)," ")," head_detail ")]');
