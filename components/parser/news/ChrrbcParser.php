...
class ChrrbcParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://chr.rbc.ru/';
    public const NEWSLIST_URL = 'https://chr.rbc.ru/chr/';
