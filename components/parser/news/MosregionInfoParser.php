...
class MosregionInfoParser extends AbstractBaseParser
{
    ...
    {
        return 'https://www.mosregion.info/';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//*[contains(@class,"heateor_sss_sharing_container")]');
