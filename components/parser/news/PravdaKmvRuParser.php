...
class PravdaKmvRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $image = null;
        $mainImageCrawler = $contentCrawler->filterXPath('//img[contains(@class,"wp-post-image")]');
        if ($this->crawlerHasNodes($mainImageCrawler)) {
            $image = $mainImageCrawler->attr('src');
            $this->removeDomNodes($contentCrawler, '//img[contains(@class,"wp-post-image")]/parent::a');
            $this->removeDomNodes($contentCrawler, '//img[contains(@class,"wp-post-image")]');
        }
