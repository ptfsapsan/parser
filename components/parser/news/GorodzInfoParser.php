...
class GorodzInfoParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.node-full');
        ...
        $contentCrawler = $contentCrawler->filterXPath('//div[contains(@class,"field-name-field-youtube-video")] | //div[contains(@class,"field-name-body")]');
