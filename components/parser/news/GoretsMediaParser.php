...
//    todo run
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"page_content")]')->first();
        ...
        $description = $newsPageCrawler->filterXPath('//meta[@property="og:description"]')->first();
        ...
        $this->removeDomNodes($contentCrawler, '//div[@class="rubrika"][1]/following-sibling::* | //div[@class="rubrika"][1]');
        $this->removeDomNodes($newsPostCrawler,'//p[contains(@class,"gray-line")]');
        $this->removeDomNodes($contentCrawler, '//h1[1] | //a[@class="lightview"][1]');
