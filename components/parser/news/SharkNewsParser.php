...
class SharkNewsParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"tags")]/parent::div/following-sibling::*');
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"tags")]/parent::div');
