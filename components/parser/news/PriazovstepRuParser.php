...
class PriazovstepRuParser implements ParserInterface
{
    /*run*/
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'https://priazovstep.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $mainImageCrawler = $contentCrawler->filterXPath('//header[contains(@class,"entry-header")]/img[1]');
        if ($this->crawlerHasNodes($mainImageCrawler)) {
            $image = $mainImageCrawler->attr('src');
            $this->removeDomNodes($contentCrawler, '//header[contains(@class,"entry-header")]/img[1]');
        }
        ...
        $this->removeDomNodes($contentCrawler, '//div[contains(@class,"pageviews-wrapper")]');
