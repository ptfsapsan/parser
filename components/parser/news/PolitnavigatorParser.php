...
class PolitnavigatorParser extends AbstractBaseParser
{
    ...
    {
        return 'https://www.politnavigator.net';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $image = null;
        $mainImageCrawler = $newsPageCrawler->filterXPath('//img[contains(@class,"b-post-home__thumb")]')->first();
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[contains(@class,"news_content")]');
        $this->removeDomNodes($contentCrawler, '//p[contains(@class,"hide_mobile")]');
