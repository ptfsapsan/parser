 ...
 * @fullrss
 */
class StavropolyeTvParser extends MediasferaNewsParser implements ParserInterface
{
    ...
    public const SITE_URL = 'https://stavropolye.tv/';
    public const NEWSLIST_URL = 'https://stavropolye.tv/rss.xml';
