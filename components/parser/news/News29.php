 ...
 *
 */
class News29 extends Aleks007smolBaseParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
     ...
     */
    const MAIN_PAGE_URI = 'https://www.news29.ru';

    /**
     * CSS класс, где хранится содержимое новости
     */
    const BODY_CONTAINER_CSS_SELECTOR = '.ns_news';
     ...
     * в формате RegExp
     */
    const EXCLUDE_CSS_CLASSES_PATTERN = 'nd_ln_float';
     ...
     */
    const FEED_URL = 'https://www.news29.ru/rss';
