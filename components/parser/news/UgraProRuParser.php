...
class UgraProRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//*[@id="omc-full-article"]');
        ...
        // $descriptionCrawler = $newsPostCrawler->filterXPath('//*[@class="jeg_post_subtitle"]');
        // if ($this->crawlerHasNodes($descriptionCrawler) && $descriptionCrawler->text() !== '') {
        //     $previewNewsItem->setDescription($descriptionCrawler->text());
        //     $this->removeDomNodes($newsPostCrawler, '//*[@class="jeg_post_subtitle"]');
        // }
        ...
        | //*[following-sibling::*[@class="omc-single-tags"]][last()]/following-sibling::*
        | //*[@class="omc-post-heading-standart"]
        | //*[@class="omc-date-time"]');
